        ...
        <div class="container">
            ...
            <div class="card offset-3 mt-5">
                ...
                <div class="card-body px-lg-5 pt-0">
                    <form class="text-center " method="post" name="edit" action="{{route('Artist.store')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="md-form mt-3">
                            <textarea id="materialContactFormMessage" class="form-control md-textarea" name="Artist_Description" placeholder="Description about Yourself" rows="7" required></textarea>
                        </div>
