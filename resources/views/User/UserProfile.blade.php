    ...
    <div class="container emp-profile">
        <form method="post">
            ...
            <div class="col-md-2 offset-4">
                <a class="btn btn-outline-primary" href="{{route('UserProfileEdit',Auth::user()->id)}}">Edit Profile</a>
            </div>
            <div class="col-md-2">
                <a class="btn btn-outline-primary" href="{{route('Review.index',Auth::user()->id)}}" >Review</a>
            </div>
            </div>
        </form>
    </div>
