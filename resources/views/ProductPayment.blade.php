...
@section('content')
    ...
    <div class="banner">
        <img style="width: 100%; height: 1200px; " src={{asset('assets/images/Ocean2.jpg')}}>
    </div>
                ...
                <div class="card-body px-lg-5 pt-0">
                    <form class="text-center " method="post" name="edit" action="{{route('ProductBuy.store',['id'=>$product->id])}}">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-12">
                                <input readonly name="Name" value="{{$product->Product_Name}}" class="form-control">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input readonly name="Detail" value="{{$product->Product_Detail}}" class="form-control">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <input readonly name="Price" id="PPRICE" value="{{$product->Price}}" class="form-control">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12">
                                <input class="form-control" name="quantity" id="QTY" onKeyUp="multiply()" onMouseUp="multiply()" onKeyDown="return false" type="number" min="1" max="{{$product->Quantity}}" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
    ...
    <div class="card dbd">
    <div class="row">
        <div class="Reviews mt-5 col-lg-9 offset-2">
